  ...
  return (
    <div className="h-full w-full overflow-y-auto bg-background p-6">
      <div className="max-w-2xl mx-auto space-y-8 mt-8">
        ...
        <div className="bg-card border border-border rounded-xl p-8 space-y-8">
          ...
          <div className="flex items-center gap-6 pb-8 border-b border-border">
            <Avatar className="w-24 h-24 border-2 border-border shadow-md">
              ...
              <AvatarFallback className="text-2xl">{me.username.slice(0, 2).toUpperCase()}</AvatarFallback>
            </Avatar>
            <div>
              ...
              <div className="flex items-center gap-2 mt-1">
                ...
                <span className="text-sm font-mono text-muted-foreground">ID: {me.userId.split('_')[1] || me.userId}</span>
              </div>
            </div>
          </div>
        ...
        <div className="bg-card border border-border rounded-xl p-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
          ...
          <Button variant="destructive" onClick={() => signOut({ redirectUrl: import.meta.env.BASE_URL.replace(/\/$/, '') || "/" })}>
